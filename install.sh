...
# @@File             :  install.sh
# @@Description      :  Install configurations for nitrogen
...
__run_post_install() {
  local getRunStatus=0
  __replace_one "/home/user/config" "$HOME/.config" "$APPDIR/bg-saved.cfg"
  return $getRunStatus
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
